...
<button type="button" class="btn btn-primary fa fa-list" data-toggle="modal" data-target="#modalMostrarCorral{{ $corral->idCorral }}"> Mostrar</button>
<!-- Modal -->
<div class="modal fade" id="modalMostrarCorral{{ $corral->idCorral }}" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Datos del Corral</h4>
            </div>
