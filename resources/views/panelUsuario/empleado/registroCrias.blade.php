    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Registro de Crias</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
...
<div class="container">
    <div class="row">
        <div class="col-md-9">
                ...
                <div class="form-group">
                    <table class="table">
                        <tbody>
                            <th>
                                {!! Form::label ('Registro:') !!}
                                {!! Form::label ($registro->idRegistro) !!}
                            </th>
                            <th>
                                {!! Form::label ('Usuario:') !!}
            ...
            <div class="col-lg-2"  align="center">
                @include('panelUsuario.empleado.crias.forms.modalAgregarCria')
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            {!! Form::open(['route' => ['registro.finalizar', $registro->idRegistro], 'method' => 'POST', 'class' => 'form', 'align' => 'center']) !!}
            {!! Form::submit('Finalizar registro',['class' => 'btn btn-primary fa fa-trash-o']) !!}
        </div>
    </div>
</div>
@endsection
