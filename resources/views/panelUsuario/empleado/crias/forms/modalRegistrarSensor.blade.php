...
<button type="button" class="btn btn-success fa fa-plus" data-toggle="modal" data-target="#modalRegistrarSEnsor"> Registrar Cria</button>
<!-- Modal -->
<div class="modal fade" id="modalRegistrarSEnsor" role="dialog">
