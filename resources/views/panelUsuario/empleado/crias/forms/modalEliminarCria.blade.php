...
<button type="button" class="btn btn-danger fa fa-trash" data-toggle="modal" data-target="#modalEliminar{{ $cria->idCria }}"> Eliminar</button>
<!-- Modal -->
<div class="modal fade" id="modalEliminar{{ $cria->idCria }}" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminación de Cria</h4>
            </div>
            <div class="modal-body">
                <h2 align='center'>¿Esta seguro que desea eliminar la cria {{ $cria->idCria }}?</h2> 
                <div class="container">
            ...
            <div class="modal-footer">
                <div class ="btn">
                    {!! Form::open(['route' => ['crias.destroy', $cria->idCria], 'method' => 'DELETE']) !!}
                            <div>
