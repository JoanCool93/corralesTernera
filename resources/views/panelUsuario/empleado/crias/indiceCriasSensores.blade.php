    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Registro datos de sensores</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-9  table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    @endif
                    <th class="col-lg-1">{{$cria->idSensor}}</th>
                    <th class="col-lg-1">             
                        @include('panelUsuario.empleado.signosVitales.forms.modalAgregarSignoVital')
                    </th>
                </tbody>
                @endforeach
            </table>
